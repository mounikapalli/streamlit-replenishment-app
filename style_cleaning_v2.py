    ...
    try:
        ...
        for col, config in required_cols.items():
            if col in col_mapping:
                # Basic cleaning using Polars string operations
                cleaned_df = cleaned_df.with_columns([
                    pl.when(pl.col(col_mapping[col]).is_null())
        ...
        # Standardize gender values using Polars string operations
        gender_mappings = {
            "MENS": "Men",
            "MALE": "Men",
            "M": "Men",
        ...
        cleaned_df = cleaned_df.with_columns([
            pl.col("GENDER")
            .str.to_uppercase()
            .map_dict(gender_mappings, default="Unisex")
            .alias("GENDER")
        ])
